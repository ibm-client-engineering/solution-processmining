  ...
  const config = {
      ...
      [
        ...
        ({
          docs: {
            ...
            editUrl:
              'https://github.com/ibm-client-engineering/solution-processmining/tree/main/packages/create-docusaurus/templates/shared/',
          },
          theme: {
          ...
          blog: {
            ...
            editUrl: ({ locale, blogDirPath, blogPath, permalink }) =>
              `https://github.com/ibm-client-engineering/solution-processmining/edit/main/${blogDirPath}/${blogPath}`,
    ...
    themeConfig:
      ...
      ({
        ...
        navbar: {
          title: '| IBM CP4BA Process Mining on Openshift',
          logo: {
            alt: 'My Site Logo',
            src: 'img/logo.svg',
          ...
          items: [
            ...
            {
              href: 'https://github.com/ibm-client-engineering/solution-processmining',
